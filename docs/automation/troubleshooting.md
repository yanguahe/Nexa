...
nexa system heartbeat last
nexa logs --follow
nexa config get agents.defaults.heartbeat
nexa channels status --probe
```
...
```bash
nexa config get agents.defaults.heartbeat.activeHours
nexa config get agents.defaults.heartbeat.activeHours.timezone
nexa config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
nexa cron list
nexa logs --follow
```
