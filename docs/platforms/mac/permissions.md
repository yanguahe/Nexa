...
- Same path: run the app from a fixed location (for Nexa, `dist/Nexa.app`).
...
Workaround: move files into the Nexa workspace (`~/.nexa/workspace`) if you want to avoid per-folder grants.
