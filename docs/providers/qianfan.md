---
summary: "Use Qianfan's unified API to access many models in Nexa"
read_when:
...
3. Nexa installed on your system
...
4. Copy the API key for use with Nexa

## CLI setup

```bash
nexa onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Nexa Configuration](/gateway/configuration)
