---
summary: "Use Synthetic's Anthropic-compatible API in Nexa"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Nexa registers it as the
...
Note: Nexa's Anthropic client appends `/v1` to the base URL, so use
