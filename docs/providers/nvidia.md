---
summary: "Use NVIDIA's OpenAI-compatible API in Nexa"
read_when:
  - You want to use NVIDIA models in Nexa
...
nexa onboard --auth-choice skip
nexa models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
