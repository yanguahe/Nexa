...
You can point Nexa at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Nexa
...
- [Anthropic provider](/providers/anthropic) - Native Nexa integration with Claude setup-token or API keys
