---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Nexa"
read_when:
  - You want Xiaomi MiMo models in Nexa
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Nexa uses
