...
Nexa treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.nexa/settings/voicewake.json`

Shape:

```json
{ "triggers": ["nexa", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
