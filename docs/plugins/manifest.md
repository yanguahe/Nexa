...
read_when:
  - You are building a Nexa plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (nexa.plugin.json)

Every plugin **must** ship a `nexa.plugin.json` file in the **plugin root**.
Nexa uses this manifest to validate configuration **without executing plugin
