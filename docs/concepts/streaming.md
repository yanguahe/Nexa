...
Nexa has two separate “streaming” layers:
...
When block streaming is enabled, Nexa can **merge consecutive block chunks**
...
When draft streaming is active, Nexa disables block streaming for that reply to avoid double-streaming.
