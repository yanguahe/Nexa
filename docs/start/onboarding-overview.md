---
summary: "Overview of Nexa onboarding options and flows"
read_when:
...
Nexa supports multiple onboarding paths depending on where the Gateway runs
...
- [`nexa onboard` command](/cli/onboard)

## macOS app onboarding

Use the Nexa app when you want a fully guided setup on macOS. Docs:
