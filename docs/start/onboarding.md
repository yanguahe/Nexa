---
summary: "First-run onboarding flow for Nexa (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Nexa">
...
<Step title="CLI">
  ...
  The app can install the global `nexa` CLI via npm/pnpm so terminal
