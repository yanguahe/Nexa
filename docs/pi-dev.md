...
This guide summarizes a sane workflow for working on the pi integration in Nexa.
...
- Trigger the agent directly:
  - `pnpm nexa agent --message "Hello" --thinking low`
...
State lives under the Nexa state directory. Default is `~/.nexa`. If `NEXA_STATE_DIR` is set, use that directory instead.

To reset everything:

- `nexa.json` for config
...
- [https://docs.nexa.ai/testing](https://docs.nexa.ai/testing)
- [https://docs.nexa.ai/start/getting-started](https://docs.nexa.ai/start/getting-started)
