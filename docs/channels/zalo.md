...
- Install via CLI: `nexa plugins install @nexa/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `nexa plugins install ./extensions/zalo`
   - From npm (if published): `nexa plugins install @nexa/zalo`
...
- Approve via:
  - `nexa pairing list zalo`
  - `nexa pairing approve zalo <CODE>`
...
- Example: `nexa message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `nexa channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `nexa logs --follow`
