...
Nexa ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Nexa also aligns
the install method:
...
When you switch channels with `nexa update`, Nexa also syncs plugin sources:
