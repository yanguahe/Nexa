## Nexa Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_nexa-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm nexa gateway --port 18789 --verbose
```
