...
final class ScreenController {
    ...
    /// Callback invoked when an nexa:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = NexaKitResources.bundle
...
/// Handles navigation policy to intercept nexa:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept nexa:// deep links.
        if url.scheme?.lowercased() == "nexa" {
