...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: NexaPhotosLatestParams) async throws -> NexaPhotosLatestPayload {
        ...
        return NexaPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> NexaPhotoPayload
    {
