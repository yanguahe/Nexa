...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = NexaLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = NexaLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.nexa.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(NexaLocationMode.off.rawValue)
                            Text("While Using").tag(NexaLocationMode.whileUsing.rawValue)
                            Text("Always").tag(NexaLocationMode.always.rawValue)
                        }
                        ...
                        Text("Keeps the screen awake while Nexa is open.")
                            .font(.footnote)
                            .foregroundStyle(.secondary)
                    }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = NexaLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private var locationMode: NexaLocationMode {
        NexaLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
