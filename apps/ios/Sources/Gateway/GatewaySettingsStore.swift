...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.nexa.gateway"
    private static let nodeService = "ai.nexa.node"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.nexa.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.nexa.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("nexa-gateway.log")
    }
