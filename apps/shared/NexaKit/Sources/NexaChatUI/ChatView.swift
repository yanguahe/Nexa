...
@MainActor
public struct NexaChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: NexaChatViewModel
    ...
    private var visibleMessages: [NexaChatMessage] {
        let base: [NexaChatMessage]
    ...
    private func mergeToolResults(in messages: [NexaChatMessage]) -> [NexaChatMessage] {
    ...
    private func isToolResultMessage(_ message: NexaChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: NexaChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: NexaChatMessage) -> String {
