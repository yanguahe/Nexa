...
public typealias NexaPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias NexaPlatformImage = UIImage
#endif

public struct NexaChatUsageCost: Codable, Hashable, Sendable {
...
public struct NexaChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: NexaChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(NexaChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct NexaChatMessageContent: Codable, Hashable, Sendable {
...
public struct NexaChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [NexaChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: NexaChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [NexaChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: NexaChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(NexaChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([NexaChatMessageContent].self, forKey: .content) {
...
public struct NexaChatHistoryPayload: Codable, Sendable {
...
public struct NexaSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct NexaSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [NexaSessionPreviewItem]
}

public struct NexaSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [NexaSessionPreviewEntry]

    public init(ts: Int, previews: [NexaSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct NexaChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct NexaChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct NexaAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct NexaChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct NexaGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct NexaPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: NexaPlatformImage?
...
public struct NexaChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
