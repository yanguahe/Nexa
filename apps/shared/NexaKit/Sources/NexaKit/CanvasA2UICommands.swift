...
public enum NexaCanvasA2UICommand: String, Codable, Sendable {
...
public struct NexaCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct NexaCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
