...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.nexa", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Nexa windows, but below the system’s pop-up menus.
