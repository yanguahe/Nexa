...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .nexaSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? NexaPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? NexaPaths.stateDirURL.path
...
extension Notification.Name {
    static let nexaSelectSettingsTab = Notification.Name("nexaSelectSettingsTab")
}
