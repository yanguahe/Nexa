...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/nexa/nexa") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/nexa/nexa")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://nexa.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "NexaBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "NexaBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "NexaGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "NexaGitCommit") as? String) ??
            "unknown"
    }
