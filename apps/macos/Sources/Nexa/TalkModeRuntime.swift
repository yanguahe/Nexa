...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.nexa", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.nexa", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [NexaChatMessage] = messages.compactMap { item in
