...
enum DebugActions {
    private static let verboseDefaultsKey = "nexa.debug.verboseMain"
    private static let sessionMenuLimit = 12
    private static let onboardingSeenKey = "nexa.onboardingSeen"
    ...
    static func sendTestNotification() async {
        _ = await NotificationManager().send(title: "Nexa", body: "Test notification", sound: nil)
    }
    ...
    private static func resolveSessionStorePath() -> String {
        ...
        let configURL = NexaPaths.configURL
        guard
