...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.nexa", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return NexaConfigFile.defaultWorkspaceURL() }
