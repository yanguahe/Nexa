...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.nexa", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Nexa/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__nexa__/a2ui/").absoluteString + "?platform=macos"
    }
