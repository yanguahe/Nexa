...
enum UIStrings {
    static let welcomeTitle = "Welcome to Nexa"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "nexa.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: NexaOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: NexaChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g nexa@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: NexaChatViewModel(
