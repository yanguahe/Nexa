...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = NexaConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = NexaConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = NexaConfigFile.loadDict()
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/nexa"
        state.remoteCliPath = ""
        return state
    }
}
