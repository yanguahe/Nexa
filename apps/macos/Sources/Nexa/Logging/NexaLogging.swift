...
enum NexaLogging {
    ...
    private static let didBootstrap: Void = {
        LoggingSystem.bootstrap { label in
            ...
            let osHandler = NexaOSLogHandler(subsystem: subsystem, category: category)
            let fileHandler = NexaFileLogHandler(label: label)
...
extension Logging.Logger {
    init(subsystem: String, category: String) {
        NexaLogging.bootstrapIfNeeded()
        let label = NexaLogging.makeLabel(subsystem: subsystem, category: category)
...
struct NexaOSLogHandler: LogHandler {
...
struct NexaFileLogHandler: LogHandler {
    let label: String
    var metadata: Logger.Metadata = [:]
        ...
        line: UInt)
    {
        ...
        let (subsystem, category) = NexaLogging.parseLabel(self.label)
