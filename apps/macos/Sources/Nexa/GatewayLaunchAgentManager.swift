...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.nexa", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".nexa/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.nexaCommand(
            subcommand: "gateway",
