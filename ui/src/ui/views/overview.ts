      ...
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">nexa dashboard --no-open</span> → open the Control UI<br />
            <span class="mono">nexa doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
              href="https://docs.nexa.ai/web/dashboard"
              target="_blank"
              rel="noreferrer"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.nexa.ai/gateway/tailscale"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            class="session-link"
            href="https://docs.nexa.ai/web/control-ui#insecure-http"
            target="_blank"
            rel="noreferrer"
              ...
              : html`
                <label class="field">
                  ...
                  <input
                    ...
                    placeholder="NEXA_GATEWAY_TOKEN"
                  />
                </label>
                <label class="field">
