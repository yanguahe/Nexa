...
process.env.NEXA_PLUGIN_MANIFEST_CACHE_MS ??= "60000";
...
// Set HOME/state isolation before importing any runtime Nexa modules.
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: NexaConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
