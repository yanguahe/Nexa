...
export function listSlackAccountIds(cfg: NexaConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: NexaConfig): string {
...
function mergeSlackAccountConfig(cfg: NexaConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: NexaConfig): ResolvedSlackAccount[] {
