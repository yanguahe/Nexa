...
export const A2UI_PATH = "/__nexa__/a2ui";

export const CANVAS_HOST_PATH = "/__nexa__/canvas";

export const CANVAS_WS_PATH = "/__nexa__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.nexaCanvasA2UIAction.postMessage(...)
  // - Android: window.nexaCanvasA2UIAction.postMessage(...)
  const handlerNames = ["nexaCanvasA2UIAction"];
  ...
  globalThis.Nexa = globalThis.Nexa ?? {};
  globalThis.Nexa.postMessage = postToNode;
  globalThis.Nexa.sendUserAction = sendUserAction;
  globalThis.nexaPostMessage = postToNode;
  globalThis.nexaSendUserAction = sendUserAction;
