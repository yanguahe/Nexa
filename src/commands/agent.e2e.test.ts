...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "nexa-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<NexaConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<NexaConfig["telegram"]>>,
