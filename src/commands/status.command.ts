...
export async function statusCommand(
  ...
  runtime.log(theme.heading("Nexa status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("nexa security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("nexa security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.nexa.ai/faq");
  runtime.log("Troubleshooting: https://docs.nexa.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("nexa status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("nexa logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("nexa status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("nexa gateway probe")}`);
  }
}
