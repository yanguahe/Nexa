...
export async function promptGatewayConfig(
  ...
  if (tailscaleMode !== "off") {
    note(
      ["Docs:", "https://docs.nexa.ai/gateway/tailscale", "https://docs.nexa.ai/web"].join(
        "\n",
      ),
      "Tailscale",
    );
  ...
  if (authMode === "trusted-proxy") {
    note(
      [
        "Trusted proxy mode: Nexa trusts user identity from a reverse proxy.",
        ...
        "Docs: https://docs.nexa.ai/gateway/trusted-proxy-auth",
      ].join("\n"),
      "Trusted Proxy Auth",
    );
