...
const ensureNexaModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveNexaAgentDir = vi.fn().mockReturnValue("/tmp/nexa-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/nexa-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureNexaModelsJson,
}));
