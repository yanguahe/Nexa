...
type PromptDefaultModelResult = { model?: string; config?: NexaConfig };
...
function resolveConfiguredModelRaw(cfg: NexaConfig): string {
...
function resolveConfiguredModelKeys(cfg: NexaConfig): string[] {
...
export function applyPrimaryModel(cfg: NexaConfig, model: string): NexaConfig {
...
export function applyModelAllowlist(cfg: NexaConfig, models: string[]): NexaConfig {
  const defaults = cfg.agents?.defaults;
