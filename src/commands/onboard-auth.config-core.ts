...
export function applyOpenrouterProviderConfig(cfg: NexaConfig): NexaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: NexaConfig): NexaConfig {
...
export function applyMoonshotProviderConfig(cfg: NexaConfig): NexaConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: NexaConfig): NexaConfig {
...
export function applyMoonshotConfig(cfg: NexaConfig): NexaConfig {
...
export function applyMoonshotConfigCn(cfg: NexaConfig): NexaConfig {
...
export function applyKimiCodeProviderConfig(cfg: NexaConfig): NexaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: NexaConfig): NexaConfig {
...
export function applySyntheticProviderConfig(cfg: NexaConfig): NexaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: NexaConfig): NexaConfig {
...
export function applyXiaomiProviderConfig(cfg: NexaConfig): NexaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: NexaConfig): NexaConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: NexaConfig): NexaConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: NexaConfig): NexaConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: NexaConfig): NexaConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: NexaConfig): NexaConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: NexaConfig): NexaConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: NexaConfig): NexaConfig {
...
export function applyXaiProviderConfig(cfg: NexaConfig): NexaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: NexaConfig): NexaConfig {
...
export function applyQianfanProviderConfig(cfg: NexaConfig): NexaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: NexaConfig): NexaConfig {
