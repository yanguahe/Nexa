...
function resolveDefaultAccountId(cfg: NexaConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: NexaConfig): boolean {
...
export function summarizeBindings(cfg: NexaConfig, bindings: AgentBinding[]): string[] {
