...
export function listWhatsAppAuthDirs(cfg: NexaConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: NexaConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: NexaConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: NexaConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: NexaConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: NexaConfig): ResolvedWhatsAppAccount[] {
