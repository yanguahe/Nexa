...
import type { NexaPackageManifest } from "../../plugins/manifest.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { ChannelMeta } from "./types.js";
import { MANIFEST_KEY } from "../../compat/legacy-names.js";
import { discoverNexaPlugins } from "../../plugins/discovery.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, NexaPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["NEXA_PLUGIN_CATALOG_PATHS", "NEXA_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<NexaPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: NexaPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverNexaPlugins({ workspaceDir: options.workspaceDir });
