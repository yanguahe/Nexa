...
export type ChannelAgentToolFactory = (params: { cfg?: NexaConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: NexaConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: NexaConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: NexaConfig }) => boolean;
  supportsCards?: (params: { cfg: NexaConfig }) => boolean;
