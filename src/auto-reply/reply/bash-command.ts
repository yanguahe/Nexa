...
function resolveForegroundMs(cfg: NexaConfig): number {
...
export async function handleBashChatCommand(params: {
  ...
  if (params.cfg.commands?.bash !== true) {
    return {
      text: "⚠️ bash is disabled. Set commands.bash=true to enable. Docs: https://docs.nexa.ai/tools/slash-commands#config",
    };
  }
