...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@nexa", { botUsername: "nexa" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@nexa args", {
        botUsername: "nexa",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "nexa" })).toBe(
      "/help@otherbot",
    );
  });
