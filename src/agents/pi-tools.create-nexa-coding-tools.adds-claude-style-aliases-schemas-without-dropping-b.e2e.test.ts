...
describe("createNexaCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createNexaCodingTools({
      config,
    ...
    const anthropicTools = createNexaCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createNexaCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createNexaCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
