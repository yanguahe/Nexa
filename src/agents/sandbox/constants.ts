...
export const DEFAULT_SANDBOX_IMAGE = "nexa-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "nexa-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "nexa-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "nexa-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "nexa-sbx-browser-";
