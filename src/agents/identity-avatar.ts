...
function resolveAvatarSource(cfg: NexaConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: NexaConfig, agentId: string): AgentAvatarResolution {
