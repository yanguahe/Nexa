...
function resolveWatchPaths(workspaceDir: string, config?: NexaConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: NexaConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: NexaConfig }) {
