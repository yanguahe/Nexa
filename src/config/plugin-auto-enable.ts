...
function isTelegramConfigured(cfg: NexaConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: NexaConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: NexaConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: NexaConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: NexaConfig): boolean {
...
function isIMessageConfigured(cfg: NexaConfig): boolean {
...
function isWhatsAppConfigured(cfg: NexaConfig): boolean {
...
function isGenericChannelConfigured(cfg: NexaConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: NexaConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: NexaConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: NexaConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: NexaConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: NexaConfig, pluginId: string): NexaConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
