...
function resolveAnthropicDefaultAuthMode(cfg: NexaConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: NexaConfig): NexaConfig {
...
export function applyTalkApiKey(config: NexaConfig): NexaConfig {
...
export function applyModelDefaults(cfg: NexaConfig): NexaConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: NexaConfig): NexaConfig {
...
export function applyLoggingDefaults(cfg: NexaConfig): NexaConfig {
...
export function applyContextPruningDefaults(cfg: NexaConfig): NexaConfig {
...
export function applyCompactionDefaults(cfg: NexaConfig): NexaConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
