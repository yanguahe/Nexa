...
import type { NexaPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: NexaPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: NexaPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
