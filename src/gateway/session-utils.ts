...
import { type NexaConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: NexaConfig): string[] {
...
export function listAgentsForGateway(cfg: NexaConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: NexaConfig): string {
...
function resolveSessionStoreAgentId(cfg: NexaConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: NexaConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: NexaConfig): GatewaySessionsDefaults {
