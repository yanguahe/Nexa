...
declare const __NEXA_VERSION__: string | undefined;

const BUNDLED_VERSION =
  (typeof __NEXA_VERSION__ === "string" && __NEXA_VERSION__) ||
  process.env.NEXA_BUNDLED_VERSION ||
  "0.0.0";
...
async function main() {
  if (hasFlag(args, "--version") || hasFlag(args, "-v")) {
    // Match `nexa --version` behavior for Swift env/version checks.
