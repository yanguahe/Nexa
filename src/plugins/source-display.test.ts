...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/nexa/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/nexa/extensions",
        global: "/Users/x/.nexa/extensions",
        workspace: "/Users/x/ws/.nexa/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.nexa/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/nexa/extensions",
        global: "/Users/x/.nexa/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.nexa/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/nexa/extensions",
        global: "/Users/x/.nexa/extensions",
