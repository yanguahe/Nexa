...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @nexa/voice-call -> voice-call).
...
export function discoverNexaPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".nexa", "extensions")];
