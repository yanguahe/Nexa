...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.NEXA_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: NexaConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: NexaConfig): string {
...
function mergeTelegramAccountConfig(cfg: NexaConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: NexaConfig): ResolvedTelegramAccount[] {
