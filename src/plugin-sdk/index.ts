...
export type { NexaConfig } from "../config/config.js";
/** @deprecated Use NexaConfig instead */
export type { NexaConfig as ClawdbotConfig } from "../config/config.js";
