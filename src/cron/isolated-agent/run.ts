...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/nexa/nexa/issues/15692
   */
  delivered?: boolean;
};
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.NEXA_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.nexa/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: NexaConfig = {
    ...params.cfg,
