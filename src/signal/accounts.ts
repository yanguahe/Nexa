...
export function listSignalAccountIds(cfg: NexaConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: NexaConfig): string {
...
function mergeSignalAccountConfig(cfg: NexaConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: NexaConfig): ResolvedSignalAccount[] {
