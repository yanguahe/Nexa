...
- `fix: <summary> (nexa#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (nexa#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "nexa#$pr_number" || { echo "ERROR: commit subject missing nexa#$pr_number"; exit 1; }
