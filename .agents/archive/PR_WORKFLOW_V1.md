...
- During `prepare-pr`, use this commit subject format: `fix: <summary> (nexa#<PR>) thanks @<pr-author>`.
...
- Read `docs/help/submitting-a-pr.md` ([Submitting a PR](https://docs.nexa.ai/help/submitting-a-pr)) for what we expect from contributors.
