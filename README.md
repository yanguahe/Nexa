...
Nexa connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.nexa.ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dmPolicy="pairing"` / `channels.slack.dmPolicy="pairing"`; legacy: `channels.discord.dm.policy`, `channels.slack.dm.policy`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `nexa pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.allowFrom` / `channels.slack.allowFrom`; legacy: `channels.discord.dm.allowFrom`, `channels.slack.dm.allowFrom`).

Run `nexa doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.nexa.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.nexa.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles (iMessage), iMessage (legacy), Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.nexa.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.nexa.ai/nodes/voicewake) + [Talk Mode](https://docs.nexa.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.nexa.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.nexa.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.nexa.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.nexa.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.nexa.ai/nodes).
- **[Onboarding](https://docs.nexa.ai/start/wizard) + [skills](https://docs.nexa.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=nexa/nexa&type=date&legend=top-left)](https://www.star-history.com/#nexa/nexa&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs.nexa.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.nexa.ai/web), and [Canvas host](https://docs.nexa.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.nexa.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.nexa.ai/start/wizard), and [doctor](https://docs.nexa.ai/gateway/doctor).
- [Pi agent runtime](https://docs.nexa.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.nexa.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.nexa.ai/concepts/groups).
- [Media pipeline](https://docs.nexa.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.nexa.ai/nodes/audio).

### Channels

- [Channels](https://docs.nexa.ai/channels): [WhatsApp](https://docs.nexa.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.nexa.ai/channels/telegram) (grammY), [Slack](https://docs.nexa.ai/channels/slack) (Bolt), [Discord](https://docs.nexa.ai/channels/discord) (discord.js), [Google Chat](https://docs.nexa.ai/channels/googlechat) (Chat API), [Signal](https://docs.nexa.ai/channels/signal) (signal-cli), [BlueBubbles](https://docs.nexa.ai/channels/bluebubbles) (iMessage, recommended), [iMessage](https://docs.nexa.ai/channels/imessage) (legacy imsg), [Microsoft Teams](https://docs.nexa.ai/channels/msteams) (extension), [Matrix](https://docs.nexa.ai/channels/matrix) (extension), [Zalo](https://docs.nexa.ai/channels/zalo) (extension), [Zalo Personal](https://docs.nexa.ai/channels/zalouser) (extension), [WebChat](https://docs.nexa.ai/web/webchat).
- [Group routing](https://docs.nexa.ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.nexa.ai/channels).

### Apps + nodes

- [macOS app](https://docs.nexa.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.nexa.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.nexa.ai/nodes/talk) overlay, [WebChat](https://docs.nexa.ai/web/webchat), debug tools, [remote gateway](https://docs.nexa.ai/gateway/remote) control.
- [iOS node](https://docs.nexa.ai/platforms/ios): [Canvas](https://docs.nexa.ai/platforms/mac/canvas), [Voice Wake](https://docs.nexa.ai/nodes/voicewake), [Talk Mode](https://docs.nexa.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.nexa.ai/platforms/android): [Canvas](https://docs.nexa.ai/platforms/mac/canvas), [Talk Mode](https://docs.nexa.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.nexa.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.nexa.ai/tools/browser): dedicated nexa Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.nexa.ai/platforms/mac/canvas): [A2UI](https://docs.nexa.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.nexa.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.nexa.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.nexa.ai/automation/cron-jobs); [webhooks](https://docs.nexa.ai/automation/webhook); [Gmail Pub/Sub](https://docs.nexa.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.nexa.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.nexa.ai/concepts/channel-routing), [retry policy](https://docs.nexa.ai/concepts/retry), and [streaming/chunking](https://docs.nexa.ai/concepts/streaming).
- [Presence](https://docs.nexa.ai/concepts/presence), [typing indicators](https://docs.nexa.ai/concepts/typing-indicators), and [usage tracking](https://docs.nexa.ai/concepts/usage-tracking).
- [Models](https://docs.nexa.ai/concepts/models), [model failover](https://docs.nexa.ai/concepts/model-failover), and [session pruning](https://docs.nexa.ai/concepts/session-pruning).
- [Security](https://docs.nexa.ai/gateway/security) and [troubleshooting](https://docs.nexa.ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.nexa.ai/web) + [WebChat](https://docs.nexa.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.nexa.ai/gateway/tailscale) or [SSH tunnels](https://docs.nexa.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.nexa.ai/install/nix) for declarative config; [Docker](https://docs.nexa.ai/install/docker)-based installs.
- [Doctor](https://docs.nexa.ai/gateway/doctor) migrations, [logging](https://docs.nexa.ai/logging).
...
- **[Gateway WebSocket network](https://docs.nexa.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.nexa.ai/gateway)).
- **[Tailscale exposure](https://docs.nexa.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.nexa.ai/gateway/remote)).
- **[Browser control](https://docs.nexa.ai/tools/browser)** — nexa‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.nexa.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.nexa.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.nexa.ai/nodes/voicewake) + [Talk Mode](https://docs.nexa.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.nexa.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

Nexa can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (Nexa enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.nexa.ai/gateway/tailscale) · [Web surfaces](https://docs.nexa.ai/web)
...
Details: [Remote access](https://docs.nexa.ai/gateway/remote) · [Nodes](https://docs.nexa.ai/nodes) · [Security](https://docs.nexa.ai/gateway/security)
...
Details: [Nodes](https://docs.nexa.ai/nodes) · [macOS app](https://docs.nexa.ai/platforms/macos) · [Gateway protocol](https://docs.nexa.ai/concepts/architecture)
...
Details: [Session tools](https://docs.nexa.ai/concepts/session-tool)
...
- Controlled via `nexa nodes …`.

Runbook: [iOS connect](https://docs.nexa.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.nexa.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.nexa/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.nexa/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.nexa/nexa.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.nexa.ai/gateway/configuration)
...
Details: [Security guide](https://docs.nexa.ai/gateway/security) · [Docker + sandboxing](https://docs.nexa.ai/install/docker) · [Sandbox config](https://docs.nexa.ai/gateway/configuration)

### [WhatsApp](https://docs.nexa.ai/channels/whatsapp)

- Link the device: `pnpm nexa channels login` (stores creds in `~/.nexa/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.nexa.ai/channels/telegram)
...
### [Slack](https://docs.nexa.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.nexa.ai/channels/discord)
...
### [Signal](https://docs.nexa.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [BlueBubbles (iMessage)](https://docs.nexa.ai/channels/bluebubbles)

- **Recommended** iMessage integration.
- Configure `channels.bluebubbles.serverUrl` + `channels.bluebubbles.password` and a webhook (`channels.bluebubbles.webhookPath`).
- The BlueBubbles server runs on macOS; the Gateway can run on macOS or elsewhere.

### [iMessage (legacy)](https://docs.nexa.ai/channels/imessage)

- Legacy macOS-only integration via `imsg` (Messages must be signed in).
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.nexa.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.nexa.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.nexa.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.nexa.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.nexa.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.nexa.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.nexa.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.nexa.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.nexa.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.nexa.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.nexa.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.nexa.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.nexa.ai/platforms/windows), [Linux](https://docs.nexa.ai/platforms/linux), [macOS](https://docs.nexa.ai/platforms/macos), [iOS](https://docs.nexa.ai/platforms/ios), [Android](https://docs.nexa.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.nexa.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.nexa.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.nexa.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.nexa.ai/gateway/bonjour)
- [Gateway pairing](https://docs.nexa.ai/gateway/pairing)
- [Remote gateway README](https://docs.nexa.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.nexa.ai/web/control-ui)
- [Dashboard](https://docs.nexa.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.nexa.ai/gateway/health)
- [Gateway lock](https://docs.nexa.ai/gateway/gateway-lock)
- [Background process](https://docs.nexa.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.nexa.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.nexa.ai/logging)

## Deep dives

- [Agent loop](https://docs.nexa.ai/concepts/agent-loop)
- [Presence](https://docs.nexa.ai/concepts/presence)
- [TypeBox schemas](https://docs.nexa.ai/concepts/typebox)
- [RPC adapters](https://docs.nexa.ai/reference/rpc)
- [Queue](https://docs.nexa.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.nexa.ai/tools/skills-config)
- [Default AGENTS](https://docs.nexa.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.nexa.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.nexa.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.nexa.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.nexa.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.nexa.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.nexa.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.nexa.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.nexa.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.nexa.ai/platforms/mac/voicewake)
- [iOS node](https://docs.nexa.ai/platforms/ios)
- [Android node](https://docs.nexa.ai/platforms/android)
- [Windows (WSL2)](https://docs.nexa.ai/platforms/windows)
- [Linux app](https://docs.nexa.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.nexa.ai/gmail-pubsub](https://docs.nexa.ai/automation/gmail-pubsub)

## Molty

Nexa was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [nexa.ai](https://nexa.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@nexa](https://x.com/nexa)
...
<p align="left">
  ...
  <a href="https://github.com/ryancnelson"><img src="https://avatars.githubusercontent.com/u/347171?v=4&s=48" width="48" height="48" alt="ryancnelson" title="ryancnelson"/></a> <a href="https://github.com/search?q=Samrat%20Jha"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="Samrat Jha" title="Samrat Jha"/></a> <a href="https://github.com/search?q=seans-nexabot"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="seans-nexabot" title="seans-nexabot"/></a> <a href="https://github.com/senoldogann"><img src="https://avatars.githubusercontent.com/u/45736551?v=4&s=48" width="48" height="48" alt="senoldogann" title="senoldogann"/></a> <a href="https://github.com/Seredeep"><img src="https://avatars.githubusercontent.com/u/22802816?v=4&s=48" width="48" height="48" alt="Seredeep" title="Seredeep"/></a> <a href="https://github.com/sergical"><img src="https://avatars.githubusercontent.com/u/3760543?v=4&s=48" width="48" height="48" alt="sergical" title="sergical"/></a> <a href="https://github.com/search?q=shatner"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="shatner" title="shatner"/></a> <a href="https://github.com/shiv19"><img src="https://avatars.githubusercontent.com/u/9407019?v=4&s=48" width="48" height="48" alt="shiv19" title="shiv19"/></a> <a href="https://github.com/shiyuanhai"><img src="https://avatars.githubusercontent.com/u/1187370?v=4&s=48" width="48" height="48" alt="shiyuanhai" title="shiyuanhai"/></a> <a href="https://github.com/Shrinija17"><img src="https://avatars.githubusercontent.com/u/199155426?v=4&s=48" width="48" height="48" alt="Shrinija17" title="Shrinija17"/></a>
