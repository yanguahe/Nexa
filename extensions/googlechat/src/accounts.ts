...
export function listGoogleChatAccountIds(cfg: NexaConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: NexaConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: NexaConfig): ResolvedGoogleChatAccount[] {
