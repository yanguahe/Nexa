...
This directory contains the **BlueBubbles external channel plugin** for Nexa.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `nexa/plugin-sdk` helpers.
