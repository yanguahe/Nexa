...
- Version alignment with core Nexa release numbers.
...
- First public release of the @nexa/voice-call plugin.
...
- CLI: `nexa voicecall` commands (call/start/continue/speak/end/status/tail/expose).
