...
import type { ReplyPayload, NexaConfig } from "nexa/plugin-sdk";
import { createReplyPrefixOptions } from "nexa/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as NexaConfig;
