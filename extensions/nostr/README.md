...
Nostr DM channel plugin for Nexa using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Nexa. It enables your bot to:
...
# Configure nexa to use local relay
