...
export function listMattermostAccountIds(cfg: NexaConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: NexaConfig): string {
...
export function listEnabledMattermostAccounts(cfg: NexaConfig): ResolvedMattermostAccount[] {
