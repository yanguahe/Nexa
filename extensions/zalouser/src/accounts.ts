...
export function listZalouserAccountIds(cfg: NexaConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: NexaConfig): string {
...
function mergeZalouserAccountConfig(cfg: NexaConfig, accountId: string): ZalouserAccountConfig {
