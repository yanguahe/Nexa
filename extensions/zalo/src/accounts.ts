...
export function listZaloAccountIds(cfg: NexaConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: NexaConfig): string {
...
function mergeZaloAccountConfig(cfg: NexaConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: NexaConfig): ResolvedZaloAccount[] {
