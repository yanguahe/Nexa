...
# Output:
# - dist/Nexa.app
# - dist/Nexa-<version>.zip
# - dist/Nexa-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Nexa-$VERSION.zip"
DMG="$ROOT_DIR/dist/Nexa-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Nexa-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Nexa-$VERSION.dSYM.zip"
