...
show_usage() {
    cat << EOF
clawlog - Nexa Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Nexa logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Nexa logs flow through the macOS unified log (subsystem: ai.nexa).
